...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      builder: (context) {
        if (Platform.isIOS) {
          return CupertinoAlertDialog(
            ...
            content: const Text(
              'Are you sure? This will permanently delete your Initial Balance and force you to start over.',
            ),
            actions: [
  ...
  Widget build(BuildContext context) {
    if (Platform.isIOS) {
      ...
      return Scaffold(
        appBar: AppBar(title: const Text('Budget Settings'), elevation: 0),
        body: _buildBody(),
      );
    }
  }
